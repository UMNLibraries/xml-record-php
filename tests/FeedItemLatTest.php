...
class FeedItemLatTest extends \PHPUnit_Framework_TestCase
{
  protected function setUp()
  {
    $this->xmlRecordClass = '\UmnLib\Core\XmlRecord\FeedItem\Lat';

    $finder = new Finder();
    $directory = dirname(__FILE__) . '/fixtures/feeditem-lat';

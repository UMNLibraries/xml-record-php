...
class FeedItemBbcTest extends \PHPUnit_Framework_TestCase
{
  protected function setUp()
  {
    $this->xmlRecordClass = '\UmnLib\Core\XmlRecord\FeedItem\Bbc';

    $finder = new Finder();
    $directory = dirname(__FILE__) . '/fixtures/feeditem-bbc';

...
class XMLRecordIteratorTest extends UnitTestCase
{
    public function __construct()
    {
        ...
        $this->directory = getcwd() . '/feeditem_bbc';
        $this->file_names = $f->name('*.xml')->in( $this->directory );
        $this->xml_record_class = 'XML_Record_FeedItem_BBC';
    }
    ...
    public function run_iterator($xri, $count)
    {
        ...
        while ($xri->valid()) {
            ...
            $version_string = '<?xml version="1.0" encoding="ISO-8859-1"?>';
            $this->assertTrue( 

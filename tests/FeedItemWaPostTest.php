...
class FeedItemWaPostTest extends \PHPUnit_Framework_TestCase
{
  protected function setUp()
  {
    $this->xmlRecordClass = '\UmnLib\Core\XmlRecord\FeedItem\WaPost';

    $finder = new Finder();
    $directory = dirname(__FILE__) . '/fixtures/feeditem-wapost';
  ...
  function runIterator($xri, $count)
  {
    ...
    while ($xri->valid()) {
      ...
      $versionString = '<?xml version="1.0" encoding="iso-8859-1"?>';
      $this->assertTrue( 
